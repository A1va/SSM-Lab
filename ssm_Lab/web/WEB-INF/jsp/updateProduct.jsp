            ...
            <section class="content"> <!--产品信息-->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <label>
                                <select class="form-control select2" style="width: 200%"
                                        name="categoryId" >
                                    <option value="68425001" selected="selected">电视</option>
                                    <option value="68425002">冰箱</option>
                                    <option value="68425003">洗衣机</option>
                                </select>
                            </label>
                        </div>
                        ...
                        <div class="col-md-2 title">产品库存</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="产品库存"
