            ...
            <div class="box box-primary">
                    ...
                    <div class="table-box">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick="location.href='${pageContext.request.contextPath}/indent/goSave'">
                                        <i class="fa fa-file-o"></i> 新建
                                    </button>
                                    <button type="button" class="btn btn-default" title="开启"
                                            onclick="location.href='${pageContext.request.contextPath}/indent/goSave'">
                                        <i class="fa fa-check"></i> 确认支付
                                    </button>
                                    <button type="button" class="btn btn-default" title="屏蔽">
                                        <i class="fa fa-ban"></i> 屏蔽
                                    </button>
                                    <button type="button" class="btn btn-default" title="刷新"
                                            onclick="location.href='${pageContext.request.contextPath}/indent/findAll'">
                        ...
                        <table id="dataList"
                            ...
                            <tr>
                                ...
                                <th class="sorting_asc">客户</th>
                                <th class="sorting_asc sorting_asc_disabled">总金额</th>
                                <th class="sorting_asc sorting_asc_disabled">产品总数</th>
                                ...
                                <%--<th class="sorting_asc sorting_asc_disabled">支付时间</th>--%>
                                <%--<th class="sorting">发货时间</th>--%>
                                <%--<th class="sorting">确认收货时间</th>--%>
                                <%--<th class="sorting_desc">订单描述</th>--%>
                            ...
                            <c:forEach items="${pageInfo.list}" var="indent">
                                ...
                                <tr>
                                    ...
                                    <td>${indent.customer.customerName }</td>
                                    <td>${indent.totalAmount }</td>
                                    <td>${indent.totalNumber }</td>
                                    <td>${indent.receiver }</td>
                                    <td>${indent.mobile }</td>
                                    <td>${indent.address }</td>
                                    <td>${indent.createTimeStr }</td>
                                    <td>${indent.payTypeStr }</td>
                                    <%--<td>${indent.payTimeStr }</td>--%>
                                    <%--<td>${indent.deliveryTimeStr }</td>--%>
                                    <%--<td>${indent.confirmTimeStr }</td>--%>
                                    <%--<td>${indent.indentDesc }</td>--%>
                                    <td class="text-center">${indent.indentStatusStr }</td>
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/indent/delete?id=${indent.id}'">删除</button>
                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/indent/findById?id=${indent.id}'">详情</button>
                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/indent/updateById?id=${indent.id}'">编辑</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="确认支付">
                                        <i class="fa fa-trash-o"></i> 确认支付
                                    </button>
                                    <button type="button" class="btn btn-default" title="屏蔽">
                                        <i class="fa fa-ban"></i> 屏蔽
                                    </button>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/indent/findAll?page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/indent/findAll?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a></li>
                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                <li><a href="${pageContext.request.contextPath}/indent/findAll?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
                            </c:forEach>
                            <li><a href="${pageContext.request.contextPath}/indent/findAll?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/indent/findAll?page=${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a>
                            </li>
                        </ul>
                    </div>
...
<script>
    function changePageSize() {
        ...
        //向服务器发送请求，改变每页显示条数
        location.href = "${pageContext.request.contextPath}/indent/findAll?page=1&pageSize="
            + pageSize;
    }
