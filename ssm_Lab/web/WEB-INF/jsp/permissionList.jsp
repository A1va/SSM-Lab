                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/permission/goSave'">
                            ...
                            <c:forEach items="${pageInfo.list}" var="permission">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/role/findRoleByIdAndAllPermission?id=${permission.id}" class="btn bg-olive btn-xs">添加角色</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
