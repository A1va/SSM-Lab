                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/user/goSave'">
                        ...
                        <table id="dataList"
                            ...
                            <thead>
                            <tr>
                                <th class="" style="padding-right: 0"><label for="selall"></label>
                            ...
                            <c:forEach var="user" items="${pageInfo.list}" >
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/user/delete?id=${user.id}'">删除</button>
                                        <a href="${pageContext.request.contextPath}/user/goUpdate?id=${user.id}" class="btn bg-olive btn-xs">编辑</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            <!--
